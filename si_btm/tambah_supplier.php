...
if(isset($_POST['submit']))
{
	...
	{
		Pelanggan::addCust($db_conn, $custID, $custNama, $custTelepon, $custAlamat, $custEmail);
...
<table border="2" bordercolordark="#000000">
  <tr>
    <td>ID: </td>
    <td><input name="supplierID" type="text" length="5" maxlength="5"></td>  
  </tr>
  <tr>
    <td>Nama: </td>
    <td><input type="text" name="supplierNama" length="20" maxlength="255"></td>
  </tr>
  <tr>
    <td>Nomor Telepon: </td>
    <td><input type="text" name="supplierTelepon" length="20" maxlength="255"></td>
  </tr>
  <tr>
    <td>Alamat: </td>
    <td><input type="text" name="supplierAlamat" length="20" maxlength="255"></td>
  </tr>
  <tr>
    <td>Email: </td>
    <td><input type="text" name="supplierEmail" length="20" maxlength="255"></td>
  </tr>
  <tr>
    <td></td>
    <td><input type="submit" name="submit" value="Tambah Supplier"></td>
  </tr>
</table>
</form>
</div>
